...
public class Uiibank {
	public static void main(String Args[]) {
		...
		driver.findElement(By.xpath("//input[@id='username']")).sendKeys("brownboy");
		driver.findElement(By.xpath("//input[@id='email']")).sendKeys("brownboy@gmail.com");
